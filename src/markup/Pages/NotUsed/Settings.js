                                                ...
                                                <form action="">
                                                    <div className="form-row">
                                                        <div className="form-group col-xl-12">
                                                            <label className="mr-sm-2 mt-2">Your Name</label>
                                        ...
                                        <div className="card">
                                            ...
                                            <div className="card-body">
                                                <form action="">
                                                    <div className="form-row">
                                                        <div className="form-group col-xl-12">
                                                            <label className="mr-sm-2 mt-2">New Email</label>
                                                            <input type="email" className="form-control" placeholder="Email" />
                                                        </div>
                                                        <div className="form-group col-xl-12">
                                                            <label className="mr-sm-2 mt-2">New Password</label>
                                            ...
                                            <div className="card-body">
                                                <form method="post" name="myform" className="personal_validate">
                                                    <div className="form-row">
                                                        ...
                                                        <div className="form-group col-xl-6">
                                                            <label className="mr-sm-2 mt-2">Country</label>
